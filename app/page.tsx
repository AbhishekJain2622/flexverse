       ...
       <section className="relative h-[90vh]  overflow-hidden bg-header" ref={heroRef}>
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-white">
          <h1 className="text-4xl font-bold leading-tight  tracking-tight md:text-7xl">
            <span className="gradient-text font-teko">Innovative Solutions for Modern Challenges</span> 
          </h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 text-center">
            <Button variant="link" className="text-primary" asChild>
              <Link href="/clients" className="flex items-center text-[30px] justify-center font-teko gap-2">
